    ...
    public class DisplayTasks {
        ...
        @FXML
        private TableColumn<Tasks, Boolean> statusColumn;  // Changedp
        // to Boolean type
        ...
        private void handleAddTask() {
            ...
            try {
                ...
                // Get the controller and set the moduleId
                AddDeleteTaskController controller = loader.getController();
                controller.setModuleId(moduleComboBox.getValue().GetID()); // Assuming getValue() returns a Module object with getId() method
        ...
        public void planningButtonOnClick(javafx.event.ActionEvent actionEvent) {
            try {
                Stage stage=new Stage();
                Stage currentStage = (Stage) projectComboBox.getScene().getWindow();
